 ...
 */
!function (a, b) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : a.hopscotch = b();
}(void 0, function () {
  "use strict";
  ...
  var a,
      ...
      l,
      m,
      n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (a) {
    return _typeof(a);
  } : function (a) {
  ...
  l = {
    ...
    invokeCallback: function invokeCallback(a) {
      return "function" == typeof a ? a() : "string" == typeof a && j[a] ? j[a]() : h.invokeCallbackArray(a);
    },
    invokeEventCallbacks: function invokeEventCallbacks(a, b) {
      var c,
          d,
          e = i[a];
    ...
    addEvtListener: function addEvtListener(a, b, c) {
      return a ? a.addEventListener ? a.addEventListener(b, c, !1) : a.attachEvent("on" + b, c) : void 0;
    },
    removeEvtListener: function removeEvtListener(a, b, c) {
    ...
    evtPreventDefault: function evtPreventDefault(a) {
    ...
    getStepTargetHelper: function getStepTargetHelper(a) {
    ...
    getStepTarget: function getStepTarget(a) {
      var b;
    ...
    getI18NString: function getI18NString(a) {
      return e[a] || d[a];
    },
    ...
    normalizePlacement: function normalizePlacement(a) {
      !a.placement && a.orientation && (a.placement = a.orientation);
    },
    flipPlacement: function flipPlacement(a) {
      if (a.isRtl && !a._isFlipped) {
        ...
        for (c in d) {
          b = d[c], a.hasOwnProperty(b) && w.hasOwnProperty(a[b]) && (a[b] = w[a[b]]);
        }
    ...
    render: function render(a, b, c) {
      ...
      for (p = 0; u > p; p++) {
        s = t[p], h.hasClass(s, "hopscotch-arrow") && (this.arrowEl = s);
      }
    ...
    _getStepNum: function _getStepNum(a) {
      var b,
          c,
          d = 0,
    ...
    _getStepI18nNum: function _getStepI18nNum(a) {
      var b = h.getI18NString("stepNums");
      return b && a < b.length ? a = b[a] : a += 1, a;
    },
    _setArrow: function _setArrow(a) {
    ...
    _handleBubbleClick: function _handleBubbleClick(a) {
      function b(c) {
    ...
    init: function init(a) {
      ...
      this.element = f, e = {
        ...
        showNumber: !0,
        isTourBubble: !0
      }, a = ("undefined" == typeof a ? "undefined" : n(a)) === q ? {} : a, h.extend(e, a), this.opt = e, f.className = "hopscotch-bubble animated", e.isTourBubble ? (d = m.getCurrTour(), d && h.addClass(f, "tour-" + d.id)) : h.addClass(f, "hopscotch-callout no-number"), b = function b() {
      ...
      }, h.addEvtListener(f, "click", this.clickCb), this.hide(), h.documentIsReady() ? document.body.appendChild(f) : (document.addEventListener ? (_c2 = function c() {
        document.removeEventListener("DOMContentLoaded", _c2), window.removeEventListener("load", _c2), document.body.appendChild(f);
      }, document.addEventListener("DOMContentLoaded", _c2, !1)) : (_c2 = function _c() {
        "complete" === document.readyState && (document.detachEvent("onreadystatechange", _c2), window.detachEvent("onload", _c2), document.body.appendChild(f));
      }, document.attachEvent("onreadystatechange", _c2)), h.addEvtListener(window, "load", _c2));
    }
  }, c = function c() {
    var a = {},
        c = {};
    this.createCallout = function (d) {
      ...
      for (b in a) {
        a.hasOwnProperty(b) && c.hasOwnProperty(b) && (d = a[b], e = c[b], d && e && d.setPosition(e));
      }
    };
  }, a = function a(_a) {
    var d,
      ...
      t >= v && (t <= v + E("scrollTopMargin") || w >= u) ? a && a() : E("smoothScroll") ? ("undefined" == typeof YAHOO ? "undefined" : n(YAHOO)) !== q && n(YAHOO.env) !== q && n(YAHOO.env.ua) !== q && n(YAHOO.util) !== q && n(YAHOO.util.Scroll) !== q ? (b = YAHOO.env.ua.webkit ? document.body : document.documentElement, d = YAHOO.util.Easing ? YAHOO.util.Easing.easeOut : void 0, c = new YAHOO.util.Scroll(b, {
        ...
        scrollTop: x
      }, E("scrollDuration"), a) : (0 > x && (x = 0), e = v > t ? -1 : 1, f = Math.abs(v - x) / (E("scrollDuration") / 10), (_g = function g() {
        var b = h.getScrollTop(),
            c = b + e * f;
        return e > 0 && c >= x || 0 > e && x >= c ? (c = x, a && a(), void window.scrollTo(0, c)) : (window.scrollTo(0, c), h.getScrollTop() === b ? void (a && a()) : void setTimeout(_g, 10));
      })()) : (window.scrollTo(0, x), a && a());
    },
        I = function P(a, b) {
      var c, d, e;
      u + a >= 0 && u + a < t.steps.length ? (u += a, d = F(), e = function e() {
      ...
      var c,
          ...
          g = C(),
          i = this;
      if (g.hide(), a = h.valOrDefault(a, !0), c = F(), c.nextOnTargetClick && h.removeEvtListener(h.getStepTarget(c), "click", G), d = c, e = b > 0 ? d.multipage : u > 0 && t.steps[u - 1].multipage, f = function f(c) {
        var f;
      ...
      for (b in a) {
        a.hasOwnProperty(b) && "id" !== b && "steps" !== b && (e[b] = a[b]);
      }
    ...
    this.getCalloutManager = function () {
      ...
      if ("undefined" == typeof d && t.id === w && ("undefined" == typeof x ? "undefined" : n(x)) !== q) {
        if (d = x, B.length > 0) for (var g = 0, i = B.length; i > g; g++) {
          e[B[g]] = !0;
        }
      } else d || (d = 0);
      ...
      for (f in i) {
        if (!a || a === f) if (b) for (c = i[f], d = 0, e = c.length; e > d; ++d) {
      ...
      for (p || this.resetDefaultOptions(), h.extend(p, a), a && h.extend(e, a.i18n), f = 0, g = i.length; g > f; ++f) {
        d = "on" + i[f].charAt(0).toUpperCase() + i[f].substring(1), a[d] && this.listen(i[f], a[d], b);
      }
